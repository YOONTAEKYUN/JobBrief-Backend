...
public class MemberService {
    ...
    public IdCheckResponseDto idCheck(String userId) {
        boolean isDuplicated =  memberRepository.findByUserId(userId).isPresent();
        return new IdCheckResponseDto(isDuplicated);
    }
}
